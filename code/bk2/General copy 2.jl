...
mutable struct GeneralExpect <: AbstractObservable
    ...
    sum::Float64
    final_value::Float64
    function GeneralExpect(filename, header, xaxis, key; key_kwargs=NamedTuple())
        new(filename, header, xaxis, key, key_kwargs, 0.0, 0.0)
    end
end
...
function measure!(obs::GeneralExpect, sys, workspace)
    ...
    op_vector = getproperty(workspace, obs.quantity_key; obs.key_kwargs...)
...
mutable struct GeneralTCorr{T_OUT0 <: Number} <: AbstractObservable
    ...
    # quantity_kwargs_t::NamedTuple
    quantity_key_0::Symbol
    # quantity_kwargs_0::NamedTuple
    # Data
    tmea::Vector{Int}
...
function GeneralTCorr(filename::String, header::String, tmea::Vector{Int}, key_t::Symbol, key_0::Symbol, L::Int, T_OUT0::Type; kwargs_t = NamedTuple(), kwargs_0 = NamedTuple())
...
function GeneralTCorr(filename::String, header::String, tmea::Vector{Int}, key::Symbol, L::Int, T_OUT::Type; kwargs_t = NamedTuple(), kwargs_0 = NamedTuple())
